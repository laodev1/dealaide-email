...
class ArchitectureView extends StateView {
	render() {
		return html`
  ...
  <div class="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
    <h1 class="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">Architecute</h1>
...
customElements.define('architecture-view', ArchitectureView);